...
export default function OrdersPage() {
  ...
  return (
    ...
    <div className="flex flex-col w-full h-fit bg-[#09090b] text-white p-8 space-y-6">
      ...
      {/* CHANGE: Removed flex-1 and min-h-0. Added h-fit.
          This ensures the table container stops after the last row. */}
        ...
        <Table className="w-full border-collapse">
          <TableHeader className="bg-zinc-900/60">
            <TableRow className="border-zinc-800 hover:bg-transparent">
              ...
              <TableHead className="text-right text-zinc-500 font-bold py-6 px-8 uppercase text-[10px] tracking-widest">
                Actions
              </TableHead>
            </TableRow>
          </TableHeader>
                ...
                <TableCell className="py-8 px-8 text-right">
                  <div className="flex justify-end gap-3">
                    <Button
                      variant="ghost"
                      size="icon"
                      className="h-10 w-10 text-zinc-500 hover:text-white hover:bg-zinc-800 rounded-xl"
                    >
