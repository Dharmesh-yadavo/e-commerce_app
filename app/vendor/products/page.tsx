...
export default function ProductsPage() {
  return (
    <div className="flex flex-col flex-1 justify-between w-full bg-[#09090b] text-white min-h-screen">
              ...
              <TableRow className="border-zinc-800/50 hover:bg-zinc-800/30 transition-all group">
                ...
                <TableCell className="py-6 px-8 text-right">
                  <div className="flex justify-end gap-2 text-zinc-500">
                    <Edit2 className="h-5 w-5 cursor-pointer hover:text-white transition-colors" />
