...
const Navigation = () => {
  return (
    <nav className="flex items-center justify-between px-8 py-5 border-b border-stone-800 bg-black/90 backdrop-blur-md sticky top-0 z-50">
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="flex items-center gap-4">
          <Link href="/vendor/signup">
            <Button
              size="lg"
              className="hidden lg:flex items-center gap-2 border-2 border-stone-700 hover:border-yellow-400/50 hover:bg-yellow-400/5 text-sm font-bold text-stone-300 transition-all group"
            >
              <Store
                size={18}
